    ...
    <div class="sidebar-wrapper" data-simplebar="true" style="background-color: black;">
        ...
        <ul class="metismenu" id="menu-collapse" is-nav>
            ...
            <span v-if="user.role_id === 1">
                ...
                <li class="mb-1">
                    <a class="btn has-arrow align-items-center rounded collapsed  dropdown-toggle"
                        data-bs-toggle="collapse" data-bs-target="#Salary-collapse" aria-expanded="false">
                        <i class="bx bx-category"></i>
                        Salary 
                    </a>
                    <div class="collapse" id="Salary-collapse" bis_skin_checked="1" style="">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li>
                                <Nuxt-link to="/salary/salary-setings"><i class="bx bx-right-arrow-alt"></i>Salary Setting </Nuxt-link>
                            </li>
                        </ul>
                    </div>
                </li>
